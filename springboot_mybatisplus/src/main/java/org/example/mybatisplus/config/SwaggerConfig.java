...
public class SwaggerConfig {
    ...
    public Docket createRestApi(){
        return new Docket(DocumentationType.SWAGGER_2) //生成swagger2规范文档
                ...
                .apis(RequestHandlerSelectors.basePackage("org.example.mybatisplus.controller"))
                //设置哪些接口生成在swagger文档上
                .paths(PathSelectors.any())
                .build()
                .apiInfo(new ApiInfoBuilder()
                        .title("SpringBoot整合MybatisPlus")
                        .description("SpringBoot整合MybatisPlus详细信息")
                        .version("1.0.0")
                        .contact(new Contact("SpringBoot-MybatisPlus", "www.google.com", "dxdsama@gmail.com"))
                        .build());
    }
}
